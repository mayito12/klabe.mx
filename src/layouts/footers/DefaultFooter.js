          ...
          <div className="row">
            <div className="col-lg-6 col-md-6 col-sm-12">
              <div className="footer-col">
                ...
                <ul>
                  {appData.footer.productos?.map((producto, index) => (
                    <li key={`footer-producto-${index}`}>
                      <svg
                      ...
                      >
                        ...
                        <path
                          ...
                          d="M23.6,16.9l-9.3,9.4c-1,1-2.6,1-3.6,0l0,0c-1-1-1-2.6,0-3.6l5.7-5.8c0.5-0.5,0.5-1.2,0-1.7l-5.7-5.8 c-1-1-1-2.6,0-3.6l0,0c1-1,2.6-1,3.6,0l9.3,9.4C24.1,15.6,24.1,16.4,23.6,16.9z"
                        />
                      </svg>
                      <Link
                        href={producto.link}
              ...
              <div className="footer-col">
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <a
                      href={`tel:${appData.footer.info.tel.replace(/[^+\d]/g, '')}`}
